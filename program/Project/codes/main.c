...
//	CCON=0x40;
//	while(1) {
//		CCAP1H=244; 244 = zero angle 0.9m pulse
//		msec(2000);
//		CCAP1H=230; 230 = maximum angle 
//		msec(2000);
  ...
  //EA=1; // enable all interrupts
	...
	//IT0=1; // falling edge ( echo falls when sound returned then program jumps into interrupt 0 function )
	//TR0=1; // running timer 0 TIMER 0 STOPS COUNTING WHEN GATE FALLS ( tr0 constant 1)
		TH0=0xB8;
	TL0=0xB8;
	TR0=1;
	CCAPM1=0x42;
...
// end of whle(cccap1) 244
				}//end of while(ccap1 234)
				}// end of while(1)
			}//end of case
		}//end of if(remote())
	}//end of while(1)
